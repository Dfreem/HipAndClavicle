setTimeout(async function () {
  ...
  const webSocketUrls = 'wss://localhost:44372/HipAndClavicle/,ws://localhost:51728/HipAndClavicle/'.split(',');
  const sharedSecret = await getSecret('');
  let connection;
